...
urlpatterns = [
    ...
    re_path(r'^api/v1/android/deeplinks$', api_sz.api_android_deeplinks),
    ...
    re_path(r'^api/v1/android/deeplink_probe$', api_dz.api_probe_deeplinks),
...
if settings.API_ONLY == '0':
    urlpatterns.extend([
        ...
        re_path(r'^start_deeplink/$',
                ...
                name='start_deeplink'),
        re_path(r'^probe_deeplinks/$',
                tests_common.probe_deeplinks,
                name='probe_deeplinks'),
